...
<body>
    ...
    <h1 style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; text-align: center;">BOOK PREVIEW</h1>
      ...
      <img class="mySlides" src="wb1.jpg">
        <img class="mySlides" src="wb2.png">
        <img class="mySlides" src="wb3.png">
        <img class="mySlides" src="wb4.png">
        <img class="mySlides" src="wb5.png">
        <img class="mySlides" src="wb6.png">
