...
<body>
    ...
    <h1 style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; text-align: center;">BOOK PREVIEW</h1>
      ...
      <img class="mySlides" src="php1.png">
        <img class="mySlides" src="php2.png">
        <img class="mySlides" src="php3.png">
        <img class="mySlides" src="php4.png">
        <img class="mySlides" src="php5.png">
        <img class="mySlides" src="php6.png">
